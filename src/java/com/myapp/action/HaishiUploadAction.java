...
import com.myapp.form.HaishiUploadForm;
 ...
 * @author liujintao
 */
public class HaishiUploadAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            ...
            throws Exception {
          HaishiUploadForm uaf=(HaishiUploadForm)form;
        //UploadJianqieForm f=(UploadJianqieForm)form;
        UploadContactBean a=new UploadContactBean();
        //JianqieForm f=(JianqieForm) form;
          String haishititle = (String) request.getSession().getAttribute("haishititle");
           String haishicontent = (String) request.getSession().getAttribute("haishicontent");
     ...
     //      Object o = b.getAttribute("jianqietitle");
      ...
      //     System.out.println(jianqietitle);
       ...
       if (myFile !=null & a!=null){
         ...
         //  System.out.println("jianqietitle");
           String path=System.getProperty("user.dir")+"\\upload\\haishi";
          FileOutputStream fos=new FileOutputStream(path+"\\"+a.HaishiContactBean(haishititle,haishicontent) + ".jpg");
