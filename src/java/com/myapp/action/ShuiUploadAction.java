...
import com.myapp.form.ShuiUploadForm;
 ...
 * @author liujintao
 */
public class ShuiUploadAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            ...
            throws Exception {
         ShuiUploadForm uaf=(ShuiUploadForm)form;
        //UploadJianqieForm f=(UploadJianqieForm)form;
        UploadContactBean a=new UploadContactBean();
        //JianqieForm f=(JianqieForm) form;
          String shuititle = (String) request.getSession().getAttribute("shuititle");
           String shuicontent = (String) request.getSession().getAttribute("shuicontent");
     ...
     //      Object o = b.getAttribute("jianqietitle");
      ...
      //     System.out.println(jianqietitle);
       ...
       if (myFile !=null & a!=null){
         ...
         //  System.out.println("jianqietitle");
           String path=System.getProperty("user.dir")+"\\upload\\shui";
          FileOutputStream fos=new FileOutputStream(path+"\\"+a.ShuiContactBean(shuititle,shuicontent) + ".jpg");
