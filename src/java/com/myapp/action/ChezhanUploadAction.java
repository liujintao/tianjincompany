 ...
 * @author liujintao
 */
public class ChezhanUploadAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
       ...
       YiliaouploadForm uaf=(YiliaouploadForm)form;
        ...
        //JianqieForm f=(JianqieForm) form;
          String chezhantitle = (String) request.getSession().getAttribute("chezhantitle");
           String chezhancontent = (String) request.getSession().getAttribute("chezhancontent");
     ...
     //      Object o = b.getAttribute("jianqietitle");
      ...
      //     System.out.println(jianqietitle);
       ...
       if (myFile !=null & a!=null){
         ...
         //  System.out.println("jianqietitle");
           String path=System.getProperty("user.dir")+"\\upload\\chezhan";
          FileOutputStream fos=new FileOutputStream(path+"\\"+a.ChezhanContactBean(chezhantitle,chezhancontent) + ".jpg");
